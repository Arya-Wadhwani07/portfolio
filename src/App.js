  ...
  return (
    <>
      ...
      <nav>
        ...
        <a href="https://drive.google.com/file/d/1Er4ewXISSRqp9cs5oCefVDtgGLfcqAPH/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="nav-cta">Resume</a>
      </nav>
      ...
      <section id="hero">
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          <div className="hero-cta">
            ...
            <a href="https://drive.google.com/file/d/1Er4ewXISSRqp9cs5oCefVDtgGLfcqAPH/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="btn-s">{DOC_ICON} Resume</a>
          </div>
        </div>
      ...
      <section id="contact" style={{ padding:"120px 64px" }}>
        ...
        <div className="ci">
          ...
          <div className="clinks reveal d4">
            ...
            <a href="https://drive.google.com/file/d/1Er4ewXISSRqp9cs5oCefVDtgGLfcqAPH/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="clk">{DOC_ICON} Resume</a>
          </div>
        </div>
      </section>
